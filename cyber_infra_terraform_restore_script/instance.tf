...
module "instances" {
  ...
  source_image_id  = lookup(zipmap(data.oci_core_images.custom_images.images[*].display_name, data.oci_core_images.custom_images.images[*].id), each.value.source_id, null)
  ...
  capacity_reservation_id                    = each.value.capacity_reservation_id != null ? lookup(zipmap(data.oci_core_compute_capacity_reservations.compute_capacity_reservations.compute_capacity_reservations[*].display_name, data.oci_core_compute_capacity_reservations.compute_capacity_reservations.compute_capacity_reservations[*].id), each.value.capacity_reservation_id) : null
