...
agent_config {
  ...
  lifecycle {
    ignore_changes = [defined_tags, freeform_tags, create_vnic_details[0].defined_tags["Oracle-Tags.CreatedOn"], create_vnic_details[0].defined_tags["Oracle-Tags.CreatedBy"]]
  }
}
